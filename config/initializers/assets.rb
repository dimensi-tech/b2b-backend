...
audio_prefix = 'app/assets/audios/'
...
mp3         = Dir["#{audio_prefix}**/*.mp3"].map   { |x| x.gsub(audio_prefix, '') }

Rails.application.config.assets.precompile = (javascripts + css + scss + png + jpg + mp3)
